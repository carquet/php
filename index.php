...
<body>
	...
	////php -S 127.0.0.1:8000
		$teamsList = array("Real Madrid","Real Valladolid", "Atletico de Madrid", "Sevilla", "Barcelona", "Deportivo de la Coruña","Valencia", "Betis");
		$teamsLength = count($teamsList);
		$days = [];
		
		
		//condition if even => call a functionEven inside a function that pair them upnumbers
		// else call another functionOddnumbers- pair them up
